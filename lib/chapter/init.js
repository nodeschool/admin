...
module.exports = {
  ...
  run: function (input, remote) {
    ...
    var CountryDesignations = require('../country_designations.js');
    var commitLog = []
                ...
                return inquire({name: 'ok', message: json.location.name + ' seems to be in "' + country.long_name + '". Should "' + country.short_name + '"" be used as country?', type: 'confirm'})
                  .then(function (result) {
                    if (result.ok) {
                      ...
                      .then(function (result) {
                        if (result.ok === '') {
                          var areas = CountryDesignations.areas;
                          return inquire({name: 'area', message: 'What area is your country on?', type: 'list', choices: areas})
                            .then(function (result) {
                              var prettyCountriesListByArea = CountryDesignations.prettyCountriesListByArea;
                              return inquire({name: 'composedCountryName', message: result.area + '.\n What choose your country', type: 'list', choices: prettyCountriesListByArea(result.area)})
                                .then(function (result) {
