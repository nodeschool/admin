      ...
      .then(function (events) {
        ...
        var eventDataSet = {
          data: {
            location: undefined,
            startDate: null,
            startTime: input['event-start-time'] || input['event-time'] || suggestions.usualStartTime,
            endDate: null,
            endTime: input['event-end-time'] || input['event-time'] || suggestions.usualEndTime
          }
        } 
        if (input['location']) {
          try {
            location = JSON.parse(input['location'])
          } catch (e) {}
        }
