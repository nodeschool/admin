...
function drawArt (columns, art, color) {
...
function logo (columns) {
  drawArt(columns, fs.readFileSync(path.resolve(__dirname, '../../bin/nodeschool-logo.utf8.art')), chalk.bgYellow.black)
}
function text (txt, columns) {
  drawArt(columns, require('figlet').textSync(txt, {font: 'basic'}), chalk.bgBlack.white)
}
