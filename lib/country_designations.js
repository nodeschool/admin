...
exports.areas = Object.keys(exports.byGroup);

exports.prettyCountriesListByArea = (area) => {
  var countriesData = exports.byGroup;
  return Object.keys(countriesData[area]).map((el,i)=>{
    var country = countriesData[area];
